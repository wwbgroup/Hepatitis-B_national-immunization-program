...
R0 = zeros(size(para1_flow,2),size(para2_flow,2));
...
save('beta2_beta3_Re.mat','para1_flow','para2_flow','Re');
surf(para2_flow,para1_flow,Re),xlabel('beta3'),ylabel('beta2'),zlabel('Re') 
grid off 
colorbar
