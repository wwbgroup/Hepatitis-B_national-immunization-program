...
para1_flow = [0:para1/step:2*para1]; 
para2_flow = [0:para2/step:2*para2]; 
...
save('omiga2_e2_Re.mat','para1_flow','para2_flow','Re');%output
surf(para2_flow,para1_flow,Re),xlabel('e2'),ylabel('omiga2'),zlabel('Re') 
grid off 
colorbar
